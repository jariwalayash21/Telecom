...
Public Class newcustreceipt
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "tele.newcustreceipt.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachednewcustreceipt
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As newcustreceipt = New newcustreceipt
        rpt.Site = Me.Site
        Return rpt
    End Function
